        ...
        <footer class="admin-page-footer" style="background: #f8fafc; border-top: 1px solid var(--border); padding: 32px 32px 20px; margin-top: 12px;">
            <div style="display: flex; align-items: center; justify-content: space-between; gap: 24px; flex-wrap: wrap;">
                ...
                <div style="display: flex; align-items: center; gap: 10px;">
                    <a href="https://wa.me/6288233037896?text=Halo%20Admin%20SIMAKATA,%20saya%20butuh%20bantuan" target="_blank" style="width: 36px; height: 36px; border-radius: 50%; background: #ffffff; border: 1px solid var(--border); display: flex; align-items: center; justify-content: center; color: var(--text-secondary); transition: all 0.2s; text-decoration: none;" title="Hubungi Admin via WhatsApp">
