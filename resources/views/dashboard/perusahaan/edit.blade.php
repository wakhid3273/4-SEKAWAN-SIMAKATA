...
<div class="form-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="subtitle">Ubah data perusahaan yang sudah ada.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.perusahaan.update', $perusahaan->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    ...
                    <input type="text" id="lokasi" name="lokasi" class="form-control" 
                           value="{{ old('lokasi', $perusahaan->lokasi) }}" 
            ...
            <div class="form-group">
                ...
                <textarea id="tentang" name="tentang" class="form-control" 
                          placeholder="Deskripsi singkat tentang perusahaan...">{{ old('tentang', $perusahaan->tentang) }}</textarea>
            ...
            <div class="form-group" style="max-width: 300px;">
                ...
                <div class="input-with-icon">
                    ...
                    <input type="number" id="jumlah_mahasiswa" name="jumlah_mahasiswa" class="form-control" 
                           value="{{ old('jumlah_mahasiswa', $perusahaan->jumlah_mahasiswa) }}" 
